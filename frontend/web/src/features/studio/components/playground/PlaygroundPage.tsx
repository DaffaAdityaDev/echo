...
export function PlaygroundPage(props: Props) {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-zinc-100">Playground</h1>
        <p className="text-sm text-zinc-400 mt-1">Test your prompts against multiple models side-by-side.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <div className="lg:col-span-2">
          <div className="border border-zinc-800/60 bg-zinc-900/20 rounded-2xl p-5">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          {!results && !isRunning && (
            <div className="flex flex-col items-center justify-center h-64 border border-zinc-800/60 bg-zinc-900/20 rounded-2xl text-center space-y-2">
              <FlaskConical className="h-8 w-8 text-zinc-600" />
