  ...
  return (
    <div className="border border-border bg-white rounded-xs p-5 md:p-6 space-y-6 shadow-xs font-mono crosshair-container relative animate-in">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className={`px-2.5 py-1 text-[11px] font-bold uppercase rounded-xs tracking-wider ${methodVariants[method]}`}>
          {method}
        </div>
      ...
      <p className="text-xs text-muted leading-relaxed max-w-3xl font-mono">
        {description}
      </p>
