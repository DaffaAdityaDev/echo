...
import { ArrowRight, Code, BookOpen, Terminal, Shield } from 'lucide-react'
  ...
  return (
    <div className="space-y-12 max-w-4xl font-mono">
      ...
      <div className="space-y-4">
        <h2 className="text-base font-bold text-foreground border-b border-border pb-2 uppercase tracking-tight">Next Steps</h2>
        <div className="space-y-3">
          <Step number={1} title="Authenticate">
            Obtain a JWT token via{' '}
            <Link href="/docs/reference#tag-Auth" className="text-blue-600 font-bold hover:underline">POST /auth/login</Link>
          ...
          <Step number={2} title="Load Configuration (Batching)">
            ...
            <Link href="/docs/guides/settings" className="text-blue-600 font-bold hover:underline">GET /settings</Link>
          ...
          <Step number={3} title="Send a Chat Message">
            ...
            <Link href="/docs/reference#tag-Chat" className="text-blue-600 font-bold hover:underline">POST /chat</Link>
    ...
    >
      ...
      <div className="flex-1">
        <div className="flex items-center gap-2">
          <h3 className="text-xs font-bold text-foreground group-hover:text-blue-600 transition-colors uppercase tracking-tight">{title}</h3>
