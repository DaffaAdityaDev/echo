...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", isLoading, children, ...props }, ref) => {
    const variants = {
      primary:
        "bg-gradient-to-b from-gb-bright-blue to-gb-blue hover:from-gb-dark-blue hover:to-gb-dark-blue text-white border border-gb-blue/50 shadow-xs",
      ...
      outline:
        "border border-border bg-white text-foreground hover:border-gb-bright-blue hover:bg-blue-50 hover:text-gb-blue",
    };
