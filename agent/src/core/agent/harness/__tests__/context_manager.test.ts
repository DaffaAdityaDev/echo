...
describe("ContextManager", () => {
  ...
  describe("shouldCompact", () => {
    it("returns true at or above threshold ratio", () => {
      const cm = new ContextManager({ compactionThresholdRatio: 0.7 });
  ...
  describe("applyCompaction", () => {
    it("sets summary anchor and slices last N turns", () => {
      ...
      const msgs = [new HumanMessage("turn 1"), new HumanMessage("turn 2"), new HumanMessage("turn 3")];
  ...
  describe("estimateTokens", () => {
    it("returns sum of message content lengths divided by 4 (ceiled)", () => {
      const cm = new ContextManager();
      const msgs = [new SystemMessage("a".repeat(10)), new HumanMessage("b".repeat(6))];
