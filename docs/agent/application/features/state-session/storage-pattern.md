...
| Harness persistence        | `harness.ts:378` (runTurn)          | `stateStorage.set()` after each iteration          |
| Final save                 | `harness.ts:226` (runMission)       | `stateStorage.set()` after loop ends (TTL 600)     |
